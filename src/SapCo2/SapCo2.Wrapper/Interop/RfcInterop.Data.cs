...
namespace SapCo2.Wrapper.Interop
{
    internal sealed partial class RfcInterop : IRfcInterop
    {
        ...
        public RfcResultCodes GetString(IntPtr dataHandle, string name, char[] stringBuffer, uint bufferLength, out uint stringLength, out RfcErrorInfo errorInfo)
        ...
        public RfcResultCodes SetString(IntPtr dataHandle, string name, string value, uint valueLength, out RfcErrorInfo errorInfo)
        ...
        public RfcResultCodes GetStructure(IntPtr dataHandle, string name, out IntPtr structHandle, out RfcErrorInfo errorInfo)
        ...
        public RfcResultCodes GetTable(IntPtr dataHandle, string name, out IntPtr tableHandle, out RfcErrorInfo errorInfo)
